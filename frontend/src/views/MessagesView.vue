<template>
  <div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <div v-else class="space-y-2">
      ...
      >
        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-pink-100 to-purple-100 dark:from-pink-900/30 dark:to-purple-900/30 overflow-hidden flex-shrink-0 flex items-center justify-center text-xl">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-baseline justify-between">
            ...
            <span v-if="convo.last_message" class="text-xs text-gray-400">
