    ...
    <div v-else-if="profile" class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div class="p-6">
        ...
        <div v-if="!isOwnProfile" class="flex gap-3">
          <button @click="doAct('like')" class="flex-1 py-2.5 bg-pink-500 text-white rounded-full font-medium hover:bg-pink-600">
            ❤️ Like
          </button>
          <button @click="doAct('superlike')" class="px-6 py-2.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 rounded-full font-medium hover:bg-blue-100 dark:hover:bg-blue-900/50">
            ⭐ Super
          </button>
          <button @click="doAct('dislike')" class="px-6 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-full font-medium hover:bg-gray-200 dark:hover:bg-gray-600">
            👎 Pass
          </button>
        </div>
      </div>
